...
extern int sceSysconGetBaryonVersion(u32 *baryon);
extern int sceSysconGetPommelVersion(u32 *pommel);
extern int sceSysregGetTachyonVersion(void);
...
u32 _sceSysconGetBaryonVersion(u32 *baryon) {
...
u32 _sceSysconGetPommelVersion(u32 *pommel) {
	int k1 = pspSdkSetK1(0);
...
u32 _sceSysregGetTachyonVersion(void) {
	int k1 = pspSdkSetK1(0);
